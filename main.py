...
# app
bot_token = os.environ.get("TOKEN", "5869276475:AAHTl92NnTV7x-lWbJJ2mzZNgBkD6H8VrCs") 
api_hash = os.environ.get("HASH", "1627b9c32c69483b07d51e5cc399c712") 
api_id = os.environ.get("ID", "28117719")
